...
// verificando se há filmes favoritos ou criando um array de filmes favoritos
...
const renderizarLista = () =>{
  ...
  filmes.forEach((filme)=>{
      ...
      if (filmesFavoritos && filmesFavoritos.length !== 0) {
        //verifica se o filme está favoritado, se estiver, muda a imagem
        const favoritado = filmesFavoritos.some(fav => fav.id === filme.id);
        favorito.src = favoritado ? 'img/heart-fill.svg' : 'img/heart.svg';
